...
# This setting is required for AWS Lambda.
# otherwise you'll get an error in the browser like, "Invalid HTTP_HOST header: 'bodycalc.io'. You may need to add 'bodycalc.io' to ALLOWED_HOSTS"
ALLOWED_HOSTS = [
    '127.0.0.1',
    'localhost',
    '.amazonaws.com',
...
if DEBUG:
    ...
    STATIC_URL = 'https://cdn.bodycalc.io/static/'
